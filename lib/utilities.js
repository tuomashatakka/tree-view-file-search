...
export const openFile = (path=null) => {
  let { getActivePane, open } = atom.workspace
  let { activateItemAtIndex, items } = getActivePane()

  for(let index in items) {
    let { getPath } = items[index]
...
export const message = ({
  message, style='info', details=null, icon=null}) => {
